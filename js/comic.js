(function(imageproc) {
    ...
    imageproc.comicColor = function(inputData, outputData, saturation) {
        ...
        for (var i = 0; i < inputData.data.length; i += 4) {
            ...
            let {h, s, v} = imageproc.fromRGBToHSV(r, g, b);
            ...
            let returnedRGB = imageproc.fromHSVToRGB(h, s, v);
            r = returnedRGB.r;
            g = returnedRGB.g;
            b = returnedRGB.b;
            // Second, based on the saturated colour, find the matching colour from the comic colour palette
            let distance = 1000;
            for (let j = 0; j < palette.length; j++) {
                let tempDistance = Math.hypot((palette[j][0]-r), (palette[j][1]-g), (palette[j][2]-b));
